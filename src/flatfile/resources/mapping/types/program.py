...
class Program(pydantic.BaseModel):
    ...
    id: typing.Optional[str] = pydantic.Field(description="If this program was saved, this is the ID of the program")
    ...
    family_id: typing.Optional[FamilyId] = pydantic.Field(
        alias="familyId", description="Family ID of the program, if it belongs to a family"
    )
    created_at: typing.Optional[dt.datetime] = pydantic.Field(
        alias="createdAt", description="If this program was saved, this is the time it was created"
    )
    created_by: typing.Optional[UserId] = pydantic.Field(
        alias="createdBy", description="If this program was saved, this is the user ID of the creator"
    )
    ...
    summary: typing.Optional[ProgramSummary] = pydantic.Field(description="Summary of the mapping rules")
    access_token: typing.Optional[str] = pydantic.Field(
        alias="accessToken", description="If this program was saved, this token allows you to modify the program"
    )
